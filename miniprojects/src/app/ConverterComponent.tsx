    ...
    return (
        <div className="converter-container">
            <div>
                ...
                <button onClick={convertCelsiusToFehrenheit} className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-3 border border-gray-400 rounded shadow">
                    Button
                </button>
            </div>
            <div>
                ...
                <span className="converter-result">{unit}</span>
